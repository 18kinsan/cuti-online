...
<head>
  ...
  <style>
    ...
    button:hover {
      ...
      <link rel="stylesheet" href="{{route('izin.print', $izin['id'])}}" media="print" type="text/css">
...
<body>
  ...
  <p style="text-align:center"> <u> <b> IZIN TIDAK MASUK KERJA </b></u><br><br><br>
    ...
    <p>Untuk tidak masuk kantor / keluar kantor / mendahului pulang, pada : </p>
    ...
    <button class="down" id="print" onclick="hideButton()">Cetak Surat</button>
